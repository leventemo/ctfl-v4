...
* e.g., *test objects* with more than one input parameter,
...
* **to achieve 100% *coverage*** with 3-value BVA,
  + *test cases* must exercise all *coverage items*,
  + i.e., identified boundary values and their neighbors
* ***coverage***
...
* an **effective way of recording complex logic**, such as business rules

...
* in the initial phases testers typically participate
  + in requirement reviews,
  + *test analysis*,
  + *test design*
...
* each of these approaches **implements the principle of early testing** (see section 1.3) and follows a *shift-left* approach (see section 2.1.5)
...
* is an **organizational approach** aiming **to create synergy**
  + by getting **development** (including testing) and **operations** to work together to achieve a set of common goals
...
* ** participants** (not only testers, but also eg. developers, architects, product owner, business analysts) **discuss**:
